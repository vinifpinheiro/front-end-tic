...
export const ConsultMp = () => {
    ...
    const [product , setProduct] = useState<IGetMp>()
    const [verify , setVerify] = useState(Boolean)

    const handleSubmit = (event: { preventDefault: () => void; }) => {
        event.preventDefault()
        product.FeedId === idSearch? setVerify(true): console.log("not validated")
    }
            ...
            <div>
                ...
                <div className={styles.main__results}> 
                    <div className={styles.results}>
                        <h1 className={styles.results__h1}>Id Máteria Prima: <h1 className={styles.results__api}>{product.FeedId}</h1></h1>
                        <h1 className={styles.results__h1}>Peso: <h1 className={styles.results__api}>{product.Weight}</h1></h1>
                        <h1 className={styles.results__h1}>Medida: <h1 className={styles.results__api}>{product.Size}</h1></h1>
                        <h1 className={styles.results__h1}>Tipo: <h1 className={styles.results__api}>{product.Type}</h1></h1>
                    </div>
                </div>
            </div>
        )
